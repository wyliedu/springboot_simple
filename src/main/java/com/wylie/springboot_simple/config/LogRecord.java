...
import com.wylie.springboot_simple.annotation.SystemControllerLog;
import com.wylie.springboot_simple.annotation.SystemServiceLog;
import com.wylie.springboot_simple.model.system.LogAnnotation;
...
/*	@Pointcut("execution(* com.feiling.service..*(..))")
	public void aspect(){	}*/
	
    //Service层切点    
    @Pointcut("@annotation(com.feiling.annotation.SystemServiceLog)")    
     public  void serviceAspect() {    }    
    
    //Controller层切点    
    @Pointcut("@annotation(com.feiling.annotation.SystemControllerLog)")    
